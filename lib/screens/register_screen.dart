...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveScreens(
      Mobile: MobilRegisterScreen(),
      Tablet: TabletRegisterScreen(),
      Desktop: DesktopRegisterScreen(),
    );
  }
}

//Mobile Login Screen
class MobilRegisterScreen extends StatefulWidget {
  const MobilRegisterScreen({super.key});

  @override
  State<MobilRegisterScreen> createState() => _MobilRegisterScreenState();
}

class _MobilRegisterScreenState extends State<MobilRegisterScreen> {
  ...
  void _onUsernameChanged(String value) {
    setState(() {
      ...
      _isPasswordValid = _ValidateUsername(value) == null;
    });
  }
